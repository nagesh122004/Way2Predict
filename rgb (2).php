...
if(isset($_POST['predict']))
{
	...
	$branch=$_POST['branchname'];
      $op="SELECT * from diploma where ('$rank'<=rank and gender='$gender' and branchname='$branch')";
       if($op)
      {
	$query="SELECT * from diploma where ('$rank'<=rank and gender='$gender' and branchname='$branch')";
...
<a href="rgb.html"><button>Home Page</button></a>
</body></html>
