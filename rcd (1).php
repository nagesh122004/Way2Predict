...
if(isset($_POST['predict']))
{
	...
	$branch=$_POST['branchname'];
      $op="SELECT * from diploma where ('$rank'<=rank and caste='$caste' and district='$district')";
       if($op)
      {
	$query="SELECT * from diploma where ('$rank'<=rank and caste='$caste' and district='$district')";
...
<a href="rcd.html"><button>Home Page</button></a>
</body></html>
