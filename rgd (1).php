...
if(isset($_POST['predict']))
{
	...
	$branch=$_POST['branchname'];
      $op="SELECT * from diploma where ('$rank'<=rank and gender='$gender' and district='$district')";
       if($op)
      {
	$query="SELECT * from diploma where ('$rank'<=rank and gender='$gender' and district='$district')";
...
else
{
 ...
 <a href="rgd.html"><button>Home Page</button></a>
</body></html>
