...
$query="SELECT * from diploma where ('$rank'<=rank AND gender='$gender' AND caste='$caste' AND district='$district' AND branchname='$branch')";
...
<a href="project.html"><button>Home Page</button></a>
</body></html>
