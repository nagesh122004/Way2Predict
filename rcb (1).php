...
if(isset($_POST['predict']))
{
	...
	$branch=$_POST['branchname'];
      $op="SELECT * from diploma where ('$rank'<=rank and caste='$caste' and branchname='$branch')";
       if($op)
      {
	$query="SELECT * from diploma where ('$rank'<=rank and caste='$caste' and branchname='$branch')";
...
<a href="rcb.html"><button>Home Page</button></a>
</body></html>
